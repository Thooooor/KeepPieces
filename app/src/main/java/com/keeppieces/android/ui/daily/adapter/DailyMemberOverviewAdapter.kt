...
class DailyMemberOverviewAdapter(private val memberList: List<DailyMember>) :
    RecyclerView.Adapter<DailyMemberOverviewAdapter.BillItemViewHolder>() {
    override fun getItemCount(): Int = memberList.size

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DailyMemberOverviewAdapter.BillItemViewHolder {
        return DailyMemberOverviewAdapter.BillItemViewHolder(parent.inflate(R.layout.item_daily_card_detail))
    }

    override fun onBindViewHolder(holder: DailyMemberOverviewAdapter.BillItemViewHolder, position: Int) {
