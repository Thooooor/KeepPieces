...
import kotlinx.android.synthetic.main.layout_account_tab.view.*
...
class AccountTab @JvmOverloads constructor(
    context: Context,
...
//        val tvWidth = resources.displayMetrics.widthPixels - (image1.width * 5)
    ...
    init {
        View.inflate(context, R.layout.layout_account_tab, this)

        val slideInRight = Slide(Gravity.RIGHT)
        slideInRight.duration = 1000
        slideInRight.startDelay = 0

        account_detail_outcome.setOnClickListener {
            viewPager?.setCurrentItem(0,true)
        }
        account_detail_income.setOnClickListener {
