package com.keeppieces.line_chart
...
class LineGraphChart : View {
    ...
    private fun init(set: AttributeSet?) {
        ...
        val fillColor =
            ta.getColor(R.styleable.LineGraphChart_curveFillColor, Color.parseColor("#ff2A2931"))
        val borderColor =
            ta.getColor(R.styleable.LineGraphChart_curveBorderColor, Color.parseColor("#ff21AF6C"))
